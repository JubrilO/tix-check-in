...
extension UILabel {
    ...
    var letterSpace: CGFloat {
        set {
            ...
            if let currentAttrString = self.attributedText {
        ...
        get {
            if let currentLetterSpace = self.attributedText?.attribute(NSAttributedString.Key.kern, at: 0, effectiveRange: .none) as? CGFloat {
