...
public extension Animation {
    ...
    static func backgroundColor(duration: TimeInterval = 0.3, color: UIColor) -> Animation {
        return Animation(duration: duration) {$0.backgroundColor = color}
    }
    ...
    static func transformToOriginal(duration: TimeInterval = 0.3) -> Animation {
        return Animation(duration: duration, closure: {$0.transform = .identity})
    }
    
    static func transform(to transform: CGAffineTransform, duration: TimeInterval = 0.3) -> Animation {
        return Animation(duration: duration, closure: {$0.transform = transform})
    }
